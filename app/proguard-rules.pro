...
# 防止webReturn()方法被混淆
-keepclassmembers class com.rd.zhongqipiaoetong.view.WebReturn {
  public *;
}
...
-keep class com.rd.zhongqipiaoetong.common.ui.BaseListItemMo { *; }
-keep class com.rd.zhongqipiaoetong.module.account.model.** { *; }
-keep class com.rd.zhongqipiaoetong.module.homepage.model.** { *; }
-keep class com.rd.zhongqipiaoetong.module.more.model.** { *; }
-keep class com.rd.zhongqipiaoetong.module.product.model.** { *; }
-keep class com.rd.zhongqipiaoetong.module.user.model.** { *; }
-keep class com.rd.zhongqipiaoetong.network.entity.** { *; }
-keep class com.rd.zhongqipiaoetong.view.entity.** { *; }
-keep class com.rd.zhongqipiaoetong.payment.** { *; }
