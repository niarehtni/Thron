...
import com.rd.zhongqipiaoetong.view.swipe.enums.Mode;
 ...
 * Date: 2016/2/18 13:44
 * <p/>
 * Description: 如果要使用ZSwipeItem，请继承这个Adapter
 */
public abstract class BaseSwipeAdapter extends BaseAdapter {
    ...
    public void updateConvertView(View target, int position) {
        ...
        Logger.d(TAG, "updateConvertView=" + position);
    }

    public void closeAllExcept(ZSwipeItem layout) {
