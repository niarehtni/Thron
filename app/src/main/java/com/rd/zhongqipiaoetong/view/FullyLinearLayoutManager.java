...
public class FullyLinearLayoutManager extends android.support.v7.widget.LinearLayoutManager {
    ...
    private void logMeasureWarning(int child) {
        Logger.w(TAG, "Can't measure child #" + child + ", previously used dimensions will be reused." +
    ...
    private void measureChild(RecyclerView.Recycler recycler, int position, int widthSize, int heightSize, int[] dimensions) {
        ...
        try {
            ...
            Logger.w(TAG, "FullyLinearLayoutManager doesn't work well with animations. Consider switching them off", e);
            return;
        }
    ...
    private static void onMakeInsertDirtyFailed() {
        ...
        Logger.w(TAG, "Can't make LayoutParams insets dirty, decorations measurements might be incorrect");
    }
