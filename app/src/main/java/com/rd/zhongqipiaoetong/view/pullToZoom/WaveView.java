package com.rd.zhongqipiaoetong.view.pullToZoom;
...
public class WaveView extends LinearLayout {
    ...
    private void init() {
        ...
        drawable.setColorFilter(getResources().getColor(R.color.app_color_principal), PorterDuff.Mode.MULTIPLY);
        ...
        mGrayPaint.setColor(0x50ffffff);//getResources().getColor(R.color.app_white_aplh));
