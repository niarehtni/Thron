...
public class AppResultCode {
     ...
     * token过期
     */
    public static final int    EX_TOKEN_TIMEOUT             = 0x0002;
    /**
     * token不存在，无效的token
     */
    public static final int    EX_TOKEN_INVALID             = 0x0003;
    /**
     * 请求数据为空
     */
    ...
    public static final int    SUCCESS9999                  = 9999;
     ...
     * 长期不在线,token失效
     */
    public static final int    TOKEN_LOSE_EFFICACY          = 0x0002;
    /**
     * 用户不存在，无效的用户id
     */
