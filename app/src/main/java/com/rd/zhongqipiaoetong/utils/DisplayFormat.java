...
import com.rd.zhongqipiaoetong.utils.log.DateFormatter;
...
public class DisplayFormat {
    ...
    public static LayoutManagers.LayoutManagerFactory getLayoutManagers(int counts) {
        if (counts != 1) {
            return LayoutManagers.grid(counts);
        } else {
