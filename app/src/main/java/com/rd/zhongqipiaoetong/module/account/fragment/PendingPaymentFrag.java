 ...
 * Date: 2016/3/8 14:06
 * <p/>
 * Description: 回款记录{@link PaymentRecordAct} - 待回款
 */
public class PendingPaymentFrag extends BaseLazyFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        paymentVM = new PendingPaymentVM(getResources().getStringArray(R.array.paymentRecordActTips), 0);
