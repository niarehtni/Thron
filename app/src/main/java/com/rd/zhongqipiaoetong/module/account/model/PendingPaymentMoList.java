 ...
 */
public class PendingPaymentMoList {
    ...
    private List<PendingPaymentMo> returnList;
    ...
    public List<PendingPaymentMo> getReturnList() {
        return returnList;
    }

    public void setReturnList(List<PendingPaymentMo> returnList) {
