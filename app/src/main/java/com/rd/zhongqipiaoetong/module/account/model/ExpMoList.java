 ...
 */
public class ExpMoList {
    private int                page_total;
    private int                page;

    private List<ExperienceMo> ticketExperienceList;
    ...
    public List<ExperienceMo> getTicketExperienceList() {
        return ticketExperienceList;
    }

    public void setTicketExperienceList(List<ExperienceMo> ticketExperienceList) {
        this.ticketExperienceList = ticketExperienceList;
    }
