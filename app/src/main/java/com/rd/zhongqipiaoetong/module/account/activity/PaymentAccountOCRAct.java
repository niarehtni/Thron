...
import com.rd.zhongqipiaoetong.module.account.viewmodel.PaymentAccountOCRVM;
 ...
 * Description: 支付账户OCR
 */
public class PaymentAccountOCRAct extends BaseActivity {
    private AccountPaymentAccountOcrBinding binding;
    private PaymentAccountOCRVM             paymentAccountVM;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = DataBindingUtil.setContentView(this, R.layout.account_payment_account_ocr);
        paymentAccountVM = new PaymentAccountOCRVM(binding);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        paymentAccountVM.onActivityResult(requestCode, resultCode, data);
