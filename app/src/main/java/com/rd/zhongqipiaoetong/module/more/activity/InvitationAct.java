...
import com.rd.zhongqipiaoetong.module.more.viewmodel.InvitationVM;
...
public class InvitationAct extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MoreInvitationActBinding binding = DataBindingUtil.setContentView(this, R.layout.more_invitation_act);
        vm = new InvitationVM(this, binding.codeIv);
